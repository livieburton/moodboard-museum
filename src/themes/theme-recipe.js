...
const EXAMPLE_RECIPES = {
  ...
  'mermaidcore': {
    ...
    filters: {
      ...
      excludeTags: ['Battle', 'Military', 'Portraits', 'Ships', 'Harbors', 'Sailors', 'Navy'],
    },
    rationale: ['Across all classifications', 'From 1400 to 1920', 'Tagged with Mermaids, Waves, Fish, or Neptune', 'Excluding nautical and military subjects'],
    source: 'curated',
  },
  ...
  'grandmacore': {
    ...
    filters: {
      ...
      excludeTags: ['Battle', 'Military', 'Nudes', 'Mythology',
        ...
        'Gardens', 'Farm Workers', 'Fish', 'Fishing', 'Fish Market'],
    },
